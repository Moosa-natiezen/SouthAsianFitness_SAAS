  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl glass p-5 transition-all duration-300 hover:shadow-[0_0_30px_rgba(16,185,129,0.05)]">
      ...
      <div className="relative">
        ...
        {/* Content preview */}
        <div className="mt-3 line-clamp-4 text-xs leading-relaxed text-zinc-500">
          {plan.content.slice(0, 200)}...
        </div>

        {/* Footer */}
        <div className="mt-4 flex items-center justify-between border-t border-white/[0.06] pt-3">
          <span className="text-[10px] text-zinc-600">{createdDate}</span>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={deleting}
              className="rounded-lg border border-white/[0.06] bg-white/[0.02] px-3 py-1.5 text-[11px] font-medium text-zinc-500 transition-all hover:bg-red-500/10 hover:text-red-300 disabled:opacity-50"
            >
              {deleting ? "..." : "Delete"}
            </button>
          </div>
...
function PlanModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/[0.06] bg-[#09090b]/90 px-6 py-4 backdrop-blur-xl">
          <div>
