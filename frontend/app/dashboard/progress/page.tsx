  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl glass p-6">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-stone-900 dark:text-zinc-100">
          Track Your Progress
        </h1>
        <p className="mt-2 max-w-2xl text-stone-500 dark:text-zinc-500">
...
function SummaryCard({ state }: { state: SummaryState }) {
  ...
  return (
    <div className="rounded-2xl glass p-6">
      ...
      {!hasEntries ? (
        <p className="mt-4 text-stone-500 dark:text-zinc-500">
...
function StatBlock({
  ...
  let valueClass = "text-stone-900 dark:text-zinc-100";
  ...
  return (
    <div className="rounded-xl bg-stone-50 dark:bg-zinc-800 px-4 py-3">
      <p className="text-xs text-stone-500 dark:text-zinc-500">{label}</p>
  ...
  return (
    <div className="rounded-2xl glass p-6">
      ...
      <form onSubmit={handleSubmit} className="mt-4 space-y-3">
        <div>
          <label htmlFor="progress-date" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
            Date
          </label>
          <input
            id="progress-date"
        ...
        <div>
          <label htmlFor="progress-weight" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
            Weight (kg) *
          </label>
          <input
            id="progress-weight"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label htmlFor="progress-waist" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
              Waist (cm)
            </label>
            <input
              id="progress-waist"
          ...
          <div>
            <label htmlFor="progress-hip" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
              Hip (cm)
            </label>
            <input
              id="progress-hip"
        ...
        <div>
          <label htmlFor="progress-bodyfat" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
            Body Fat (%)
          </label>
          <input
            id="progress-bodyfat"
        ...
        <div>
          <label htmlFor="progress-notes" className="block text-sm font-medium text-stone-600 dark:text-zinc-400">
            Notes
          </label>
          <textarea
            id="progress-notes"
      ...
      {entries.length === 0 ? (
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-stone-200 dark:border-zinc-700 text-xs font-medium text-stone-500 dark:text-zinc-500">
            ...
            <tbody>
              {entries.map((entry, idx) => {
                ...
                return (
                  <tr
                    key={entry.id}
                    className="border-b border-stone-200 dark:border-zinc-700 last:border-0"
                  >
                    <td className="py-3 pr-4 font-medium text-stone-900 dark:text-zinc-100">
                      {formatDate(entry.recorded_on)}
                    </td>
                    <td className="py-3 pr-4 text-stone-900 dark:text-zinc-100">
                      {entry.weight_kg} kg
                    </td>
                    ...
                    <td className="py-3 pr-4 hidden md:table-cell text-stone-500 dark:text-zinc-500">
                      {entry.waist_cm != null ? `${entry.waist_cm} cm` : "—"}
                    </td>
                    <td className="py-3 pr-4 hidden md:table-cell text-stone-500 dark:text-zinc-500">
                      {entry.hip_cm != null ? `${entry.hip_cm} cm` : "—"}
                    </td>
                    <td className="py-3 pr-4 hidden lg:table-cell text-stone-500 dark:text-zinc-500">
                      {entry.body_fat_percent != null ? `${entry.body_fat_percent}%` : "—"}
                    </td>
                    <td className="py-3 pr-4 hidden lg:table-cell text-stone-500 dark:text-zinc-500 max-w-[200px] truncate">
                      {entry.notes ?? "—"}
                    </td>
