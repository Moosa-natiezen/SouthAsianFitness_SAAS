...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#05050A] px-4 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#FF4500] text-2xl font-bold text-white shadow-lg">
        SA
      </div>

      <h1 className="mt-6 text-4xl font-bold text-white">Page not found</h1>
      <p className="mt-3 max-w-md text-lg text-[#94A3B8]">
