...
export function LandingPage() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#FCFBF7]">
      {/* ── Nav ──────────────────────────────────────────────────────── */}
      <header className="fixed inset-x-0 top-0 z-50 bg-[#FCFBF7]/80 backdrop-blur-xl border-b border-stone-200/50">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-orange-500 text-xs font-bold text-stone-900 shadow-sm shadow-orange-500/20">
              SA
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-orange-500/8 px-4 py-1.5 mb-6">
                <div className="h-1.5 w-1.5 rounded-full bg-orange-500" />
                <span className="text-xs font-medium text-orange-600 tracking-wide">AI-Powered Nutrition</span>
              </div>
              <h1 className="font-serif text-4xl font-semibold leading-[1.08] tracking-tight text-stone-900 md:text-5xl lg:text-[3.5rem]">
                Track Biryani.{" "}
                <span className="text-orange-500">Not just calories.</span>
              </h1>
              ...
              <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                <Link
                  href="/onboarding"
                  className="inline-flex items-center gap-2.5 rounded-full bg-orange-500 px-8 py-3.5 text-sm font-semibold text-stone-900 shadow-lg shadow-orange-500/20 transition-all duration-200 hover:shadow-xl hover:shadow-orange-500/30 hover:bg-orange-600 active:scale-[0.97]"
                >
                  Start Tracking Free
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="absolute inset-0 m-auto h-[60%] w-[60%] rounded-full bg-orange-500/4 blur-3xl" />
              <div className="relative w-full max-w-md">
                {/* Main macro card */}
                <div className="rounded-[2rem] bg-white p-6 shadow-[0_20px_50px_rgba(0,0,0,0.05)] ring-1 ring-stone-200">
                  {/* Dish header */}
                  <div className="mb-5 flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-500/8 text-lg">
                      🍛
                    </div>
                    <div>
                  ...
                  <div className="space-y-3">
                    <MacroBar label="Protein" value={32} max={50} unit="g" color="#EA580C" />
                ...
                <div className="absolute -top-3 -right-3 rounded-2xl bg-white p-3 shadow-md ring-1 ring-stone-200">
                ...
                <div className="absolute -bottom-4 -left-4 rounded-2xl bg-white p-4 shadow-md ring-1 ring-stone-200">
      ...
      <section className="bg-[#1C1A17] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <div className="mb-4 flex justify-center gap-1">
            {[...Array(5)].map((_, i) => (
              <svg key={i} className="h-5 w-5 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button className="inline-flex items-center gap-3 rounded-2xl border border-stone-200 bg-stone-50 px-6 py-3 text-left transition-all duration-200 hover:bg-stone-100 hover:border-stone-300 active:scale-[0.97]">
              <svg className="h-7 w-7 text-stone-900" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
              </svg>
              <div>
                <div className="text-[10px] font-medium uppercase tracking-wide text-stone-500">Download on the</div>
                <div className="text-sm font-semibold text-stone-900">App Store</div>
              </div>
            </button>
            <button className="inline-flex items-center gap-3 rounded-2xl border border-stone-200 bg-stone-50 px-6 py-3 text-left transition-all duration-200 hover:bg-stone-100 hover:border-stone-300 active:scale-[0.97]">
              <svg className="h-7 w-7 text-stone-900" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                <div className="text-[10px] font-medium uppercase tracking-wide text-stone-500">Get it on</div>
                <div className="text-sm font-semibold text-stone-900">Google Play</div>
              </div>
            </button>
          </div>
        </div>
      ...
      <section id="features" className="py-24 md:py-32 bg-[#FCFBF7]">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <div id="how-it-works" className="md:row-span-2 rounded-3xl bg-white p-8 ring-1 ring-stone-200/60 shadow-sm transition-all duration-300 hover:shadow-md md:p-10">
                ...
                {[
                  ...
                  <div key={d.name} className="flex items-center justify-between rounded-xl bg-stone-50 px-3.5 py-2.5">
                    ...
                    <div className="flex gap-2">
                      <span className="text-[10px] font-medium text-orange-600">{d.cal} cal</span>
            ...
            <div className="md:col-span-2 rounded-3xl bg-white p-8 ring-1 ring-stone-200/60 shadow-sm transition-all duration-300 hover:shadow-md md:p-10">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
                <div className="flex-1">
                  <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-50 text-xl">
                    🤖
                  </div>
                  <h3 className="text-xl font-semibold text-stone-900 font-serif">
                  ...
                  <Link
                    href="/onboarding"
                    className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-orange-500 hover:text-orange-600 transition-colors"
                  >
                ...
                <div className="flex-shrink-0 rounded-2xl bg-stone-900 p-5 font-mono text-xs leading-relaxed text-stone-300 lg:w-72">
                  <div className="mb-2 text-[10px] font-medium text-orange-600 uppercase tracking-wider">Streaming</div>
                  <div className="space-y-1.5">
                    <div><span className="text-stone-600">##</span> High-Protein Plan</div>
                    <div><span className="text-stone-600">###</span> Breakfast</div>
                    <div>- Omelette + Roti</div>
                    <div>- Greek yogurt bowl</div>
                    <div><span className="text-stone-600">###</span> Lunch</div>
            ...
            <div className="md:col-span-2 rounded-3xl bg-white p-8 ring-1 ring-stone-200/60 shadow-sm transition-all duration-300 hover:shadow-md md:p-10">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
                {/* Macro targets mock */}
                <div className="flex-shrink-0 rounded-2xl bg-stone-50 p-5 ring-1 ring-stone-200/50 lg:w-64">
                  <div className="mb-3 text-[10px] font-medium text-stone-400 uppercase tracking-wider">Your Daily Targets</div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-white p-3 ring-1 ring-stone-200/50">
                    ...
                    <div className="rounded-xl bg-white p-3 ring-1 ring-stone-200/50">
                      ...
                      <div className="text-lg font-bold text-orange-600 font-serif">165g</div>
                    </div>
                    <div className="rounded-xl bg-white p-3 ring-1 ring-stone-200/50">
      ...
      {/* ── Pricing ──────────────────────────────────────────────────── */}
      <section id="pricing" className="bg-stone-100/50 py-24 md:py-32">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-2xl mx-auto">
            ...
            {/* Pro tier */}
            <div className="relative rounded-3xl border-2 border-orange-500 bg-white p-8 shadow-lg shadow-orange-500/5 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/10">
              <div className="absolute -top-3.5 right-6 rounded-full bg-orange-500 px-3 py-1 text-xs font-semibold text-stone-900 shadow-md shadow-orange-500/20">
                Most Popular
              </div>
              ...
              <Link
                href="/onboarding"
                className="mt-8 block w-full rounded-full bg-orange-500 py-3 text-center text-sm font-semibold text-stone-900 shadow-md shadow-orange-500/20 transition-all duration-200 hover:bg-orange-600 hover:shadow-lg active:scale-[0.97]"
              >
                Start free trial
              </Link>
            </div>
      ...
      <section className="bg-[#1C1A17] py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-semibold text-stone-900 md:text-4xl font-serif">
          ...
          <Link
            href="/onboarding"
            className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-orange-500 px-8 py-3.5 text-sm font-semibold text-stone-900 shadow-lg shadow-orange-500/20 transition-all duration-200 hover:shadow-xl hover:shadow-orange-500/30 hover:bg-orange-600 active:scale-[0.97]"
          >
            Start for free
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
      ...
      {/* ── Footer ───────────────────────────────────────────────────── */}
      <footer className="bg-[#1C1A17] border-t border-stone-200 py-8">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 px-6 text-sm text-stone-500 md:flex-row md:items-center md:justify-between">
          <p>© 2026 South Asian Fitness.</p>
          <div className="flex gap-6">
            <Link href="/auth/login" className="hover:text-stone-900 transition-colors">Login</Link>
