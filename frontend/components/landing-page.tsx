...
export function LandingPage() {
  return (
    <div className="min-h-screen overflow-hidden bg-background">
      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-stone-200 dark:border-zinc-700/50 print:hidden">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold text-stone-800 dark:text-zinc-200 tracking-tight">
              South Asian Fitness
            </span>
          </div>
          <nav className="hidden items-center gap-8 text-sm text-stone-500 dark:text-zinc-500 md:flex">
            <a
              href="#features"
              className="hover:text-stone-900 dark:text-zinc-100 transition-colors duration-200"
            >
              Features
            </a>
            <a
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/auth/login"
              className="text-sm text-stone-500 dark:text-zinc-500 hover:text-stone-900 dark:text-zinc-100 transition-colors duration-200"
            >
              Log in
            </Link>
            <Link
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mt-6 text-lg leading-relaxed text-stone-500 dark:text-zinc-500 max-w-lg mx-auto lg:mx-0">
                The first nutrition app built for South Asian food. 215+ cultural
                dishes with precise macros — powered by AI, designed for your
                kitchen.
              </p>
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              <div className="relative w-full max-w-md">
                ...
                <div className="absolute -bottom-4 -left-4 rounded-2xl bg-white dark:bg-zinc-900 p-4 shadow-md ring-1 ring-stone-200 dark:ring-zinc-700">
                  <div className="text-2xl font-bold text-stone-900 dark:text-zinc-100 font-serif">
                    215+
                  </div>
              ...
              {/* Secondary floating food image — next/image with priority for LCP */}
      ...
      <section className="bg-zinc-900 dark:bg-zinc-950 py-20 md:py-24">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mt-3 text-stone-400 dark:text-zinc-500">
            The smartest way to track cultural cuisines — from Karachi to
            Colombo.
          </p>
          <div className="mt-8 flex justify-center">
            <a
              href="#features"
              className="inline-flex items-center gap-2 rounded-full bg-emerald-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-emerald-600/25 transition-all duration-200 hover:bg-emerald-700 active:scale-[0.97]"
            >
      ...
      <section id="features" className="py-28 md:py-36 bg-background">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <div
              id="how-it-works"
              className="md:row-span-2 rounded-3xl bg-white dark:bg-zinc-900 p-8 ring-1 ring-stone-200 dark:ring-zinc-700/60 shadow-sm card-hover md:p-10"
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-stone-500 dark:text-zinc-500">
                From Chicken Biryani to Gulab Jamun — every dish pre-loaded with
                accurate macros per serving. Search, log, track.
              </p>
              {/* Mock food list */}
              <div className="mt-6 space-y-2.5">
                {foodItems.map((d) => (
                  <div
                    key={d.name}
                    className="flex items-center gap-3 rounded-xl bg-stone-50 dark:bg-zinc-800 px-3.5 py-2.5"
                  >
                    <Image
                      src={d.img}
                      ...
                      loading="lazy"
                    />
                    <span className="flex-1 text-xs font-medium text-stone-700 dark:text-zinc-300">
                      {d.name}
                    </span>
            ...
            <div className="md:col-span-2 rounded-3xl bg-white dark:bg-zinc-900 p-8 ring-1 ring-stone-200 dark:ring-zinc-700/60 shadow-sm card-hover md:p-10">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-stone-500 dark:text-zinc-500">
                    Get personalized meal plans AND workout routines generated in
                    real-time. Watch the AI build your plan line by line — copy,
                    save, or regenerate instantly.
                  </p>
                  <Link
                    href="/onboarding"
                ...
                <div className="flex-shrink-0 rounded-2xl bg-stone-900 p-5 font-mono text-xs leading-relaxed text-stone-300 dark:text-zinc-600 lg:w-72">
                  <div className="mb-2 text-[10px] font-medium text-emerald-600 uppercase tracking-wider">
                    Streaming
                  </div>
            ...
            <div className="md:col-span-2 rounded-3xl bg-white dark:bg-zinc-900 p-8 ring-1 ring-stone-200 dark:ring-zinc-700/60 shadow-sm card-hover md:p-10">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
                ...
                <div className="flex-shrink-0 rounded-2xl bg-stone-50 dark:bg-zinc-800 p-5 ring-1 ring-stone-200 dark:ring-zinc-700/50 lg:w-64">
                  <div className="mb-3 text-[10px] font-medium text-stone-400 dark:text-zinc-500 uppercase tracking-wider">
                    Your Daily Targets
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-white dark:bg-zinc-900 p-3 ring-1 ring-stone-200 dark:ring-zinc-700/50">
                      ...
                      <div className="text-lg font-bold text-stone-900 dark:text-zinc-100 font-serif">
                        2,350
                      </div>
                    </div>
                    <div className="rounded-xl bg-white dark:bg-zinc-900 p-3 ring-1 ring-stone-200 dark:ring-zinc-700/50">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-stone-500 dark:text-zinc-500">
                    Your calorie and macro targets are calculated using the
                    gold-standard Mifflin-St Jeor equation — personalized to your
                    body, activity level, and goals. Updated live whenever your
                    stats change.
                  </p>
                  <Link
                    href="/onboarding"
      ...
      <section
        id="pricing"
        className="bg-stone-100 dark:bg-zinc-800/50 py-28 md:py-36"
      >
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-2xl mx-auto">
            ...
            <div className="rounded-3xl border border-stone-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-8 shadow-sm card-hover">
              ...
              <p className="mt-2 text-4xl font-bold text-stone-900 dark:text-zinc-100 font-serif">
                $0
              </p>
            ...
            <div className="relative rounded-3xl border-2 border-emerald-600 bg-white dark:bg-zinc-900 p-8 shadow-lg shadow-emerald-600/5 card-hover">
              ...
              <ul className="mt-6 space-y-3.5 text-sm text-stone-600 dark:text-zinc-400">
                ...
                <li className="flex items-center gap-3">
                  <span className="text-emerald-600 font-bold">✓</span> AI
                  workout generator
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-emerald-600 font-bold">✓</span> Saved
                  plans archive
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-emerald-600 font-bold">✓</span> Priority
                  support
                </li>
              </ul>
              <Link
      ...
      <footer className="bg-zinc-900 dark:bg-zinc-950 border-t border-stone-200 dark:border-zinc-700 py-8 print:hidden">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 px-6 text-sm text-stone-500 dark:text-zinc-500 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-6">
            <Link
              href="/auth/login"
              className="hover:text-stone-900 dark:text-zinc-100 transition-colors"
            >
              Login
            </Link>
            <Link
...
const foodItems = [
  {
    ...
    cal: 520,
    p: 32,
    img: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=80&h=80&fit=crop&q=60",
  },
  {
    name: "Butter Chicken",
    cal: 450,
    p: 30,
    img: "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=80&h=80&fit=crop&q=60",
  },
  {
    name: "Daal Chawal",
    cal: 420,
    p: 20,
    img: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=80&h=80&fit=crop&q=60",
  },
  {
    name: "Paneer Tikka",
    cal: 420,
    p: 22,
    img: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=80&h=80&fit=crop&q=60",
  },
  {
    name: "Garlic Naan",
    cal: 260,
    p: 7,
    img: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=80&h=80&fit=crop&q=60",
  },
];
  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between">
        <span className="text-xs font-medium text-stone-500 dark:text-zinc-500">
          {label}
        </span>
