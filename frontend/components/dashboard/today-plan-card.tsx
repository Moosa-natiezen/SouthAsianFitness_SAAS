...
export function TodayPlanCard() {
  ...
  return (
    <div className="glass rounded-2xl p-6 transition-all duration-300 hover:border-emerald-200">
      ...
      <h2 className="mt-2 text-lg font-semibold text-stone-900 dark:text-zinc-100">{plan.plan_name}</h2>
            ...
            <div className="mt-2.5 space-y-1">
              {meal.foods.map((food) => (
                <div key={food.food_id} className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-stone-400 dark:text-zinc-500 tabular-nums">{Math.round(food.calories)} kcal</span>
                </div>
              ))}
            </div>
      ...
      <div className="mt-4 glass rounded-xl p-4">
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-stone-700 dark:text-zinc-300">Daily Total</p>
