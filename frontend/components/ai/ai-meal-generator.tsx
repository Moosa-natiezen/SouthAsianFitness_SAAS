      ...
      {(content || isStreaming) && (
        <div className="relative overflow-hidden rounded-2xl glass p-6">
          ...
          <div className="relative">
            ...
            {content && (
              <div className={`prose prose-sm prose-invert prose-zinc max-w-none print:w-full print:text-black print:bg-white ${isStreaming ? "streaming-cursor" : ""}`}>
            ...
            {!isStreaming && content && (
              <div className="mt-6 flex flex-wrap items-center gap-3 border-t border-stone-200 dark:border-zinc-700 pt-4">
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-white dark:bg-zinc-900/10 border border-stone-300 px-4 py-2.5 text-sm font-medium text-stone-600 transition-all hover:bg-stone-50 dark:bg-zinc-800 disabled:opacity-50 print:hidden"
                >
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
