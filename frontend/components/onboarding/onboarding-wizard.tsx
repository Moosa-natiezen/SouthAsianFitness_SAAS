            ...
            {fitnessGoals.map((g) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="text-lg font-semibold text-stone-900 dark:text-zinc-100">{g.label}</h3>
                  <p className="mt-1 text-sm text-stone-500 dark:text-zinc-500">{g.tagline}</p>
                  <div className="mt-3 flex items-center gap-2">
                    <span className="rounded-md bg-stone-100 dark:bg-zinc-800 px-2 py-0.5 text-xs font-medium text-stone-500 dark:text-zinc-500">
                      {g.calAdj}
                    </span>
                    <span className="text-xs text-stone-500 dark:text-zinc-500">{g.desc}</span>
                  </div>
                </div>
              </button>
            ))}
          ...
          <div className="space-y-6">
            <div className="grid gap-5 sm:grid-cols-3">
              <div className="space-y-2">
                <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Age</label>
                <input
                  type="number"
                  min={13}
                  max={120}
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Height (cm)</label>
                <input
                  type="number"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Weight (kg)</label>
                <input
                  type="number"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Sex</label>
            ...
            {/* Live TDEE Preview */}
            <div className="rounded-xl border border-stone-200 dark:border-zinc-700 bg-stone-50 dark:bg-zinc-800 p-4">
              <p className="text-xs font-medium uppercase tracking-wider text-stone-500 dark:text-zinc-500 mb-3">
                Live Preview
              </p>
              <div className="grid grid-cols-4 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-stone-900 dark:text-zinc-100">{preview.bmr}</p>
                  <p className="text-[10px] text-stone-500 dark:text-zinc-500 mt-0.5">BMR kcal</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-stone-500 dark:text-zinc-500">{preview.tdee}</p>
                  <p className="text-[10px] text-stone-500 dark:text-zinc-500 mt-0.5">TDEE kcal</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-stone-900 dark:text-zinc-100">{preview.target_calories}</p>
                  <p className="text-[10px] text-stone-500 dark:text-zinc-500 mt-0.5">Target kcal</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-stone-900 dark:text-zinc-100">{preview.protein_g}g</p>
                  <p className="text-[10px] text-stone-500 dark:text-zinc-500 mt-0.5">Protein</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {activityLevels.map((a) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-stone-900 dark:text-zinc-100">{a.label}</p>
                    <p className="text-sm text-stone-500 dark:text-zinc-500">{a.desc}</p>
                  </div>
                  <span className="rounded-lg bg-stone-100 dark:bg-zinc-800 px-2.5 py-1 text-xs font-mono text-stone-500 dark:text-zinc-500">
                    {a.multiplier}
                  </span>
                </div>
              </button>
        ...
        return (
          <FadeSlide>
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-3 text-sm text-stone-500 dark:text-zinc-500">Loading countries...</span>
            </div>
          </FadeSlide>
        );
      }
      ...
      return (
        <FadeSlide>
          <div className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Country</label>
              <select
                name="country_id"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Region / state</label>
              <select
                name="region_id"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Currency</label>
                <input
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Unit System</label>
                <select
                  name="unit_system"
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {dietPatterns.map((d) => (
              ...
              >
                ...
                <p className="text-sm text-stone-500 dark:text-zinc-500">{d.desc}</p>
              </button>
            ))}
          </div>
        </FadeSlide>
    ...
    if (stepIndex === 5) {
      return (
        <FadeSlide>
          <div className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Foods you like (optional)</label>
              <input
              ...
              />
              <p className="text-xs text-stone-500 dark:text-zinc-500">Comma-separated</p>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Foods you dislike (optional)</label>
              <input
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Allergies / restrictions (optional)</label>
              <input
    ...
    return (
      <FadeSlide>
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Weekly budget</label>
            <input
              type="number"
              min={0}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-500 dark:text-zinc-500">Frequency</label>
            <select
              name="budget_period"
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0a0a0a]">
        <FadeSlide className="text-center">
          ...
          <p className="mt-3 text-stone-500 dark:text-zinc-500">
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0a0a0a]">
        <FadeSlide className="text-center">
          ...
          <h2 className="font-serif text-4xl font-bold text-stone-900 dark:text-zinc-100">Your targets are set</h2>
          <div className="mt-8 grid grid-cols-2 gap-6 sm:grid-cols-4">
            <div className="rounded-2xl border border-stone-300 bg-stone-50 dark:bg-zinc-800 p-5">
              <p className="text-3xl font-bold text-stone-900 dark:text-zinc-100">{result.target_calories}</p>
              <p className="mt-1 text-xs text-stone-500 dark:text-zinc-500">kcal / day</p>
            </div>
            <div className="rounded-2xl border border-stone-300 bg-stone-50 dark:bg-zinc-800 p-5">
              <p className="text-3xl font-bold text-stone-900 dark:text-zinc-100">{result.target_protein_g}g</p>
              <p className="mt-1 text-xs text-stone-500 dark:text-zinc-500">protein / day</p>
            </div>
          </div>
          <p className="mt-8 text-sm text-stone-500 dark:text-zinc-500">Redirecting to your dashboard...</p>
        </FadeSlide>
      </div>
    );
  }
      ...
      <div className="w-full max-w-2xl">
        ...
        <FadeSlide key={`header-${stepIndex}`}>
          <div className="mb-10 text-center">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-stone-900 dark:text-zinc-100/60">
              Step {stepIndex + 1} of {totalSteps}
            </p>
            <h1 className="mt-3 font-serif text-3xl font-bold text-stone-900 dark:text-zinc-100 sm:text-4xl">
        ...
        <FadeSlide className="mt-8 flex items-center justify-between gap-4">
          <button
            ...
            className="rounded-xl border border-stone-200 dark:border-zinc-700 bg-stone-50 dark:bg-zinc-800 px-6 py-2.5 text-sm font-medium text-stone-500 dark:text-zinc-500 transition-all hover:bg-stone-50 dark:bg-zinc-800 disabled:opacity-30"
          >
            Back
          </button>
